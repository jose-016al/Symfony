...
class __TwigTemplate_1a37117888e1e55075677035f4fbc16e extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 179, $this->source); })()), "data", [], "any", false, false, false, 179), "forms", [], "any", false, false, false, 179))) {
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 183
                echo "                ";
                echo twig_call_macro($macros["__internal_parse_0"], "macro_form_tree_entry", [$context["formName"], $context["formData"], true], 183, $context, $this->getSourceContext());
                echo "
            ";
            }
...
{% endmacro %}
", "@WebProfiler/Collector/form.html.twig", "D:\\github\\symfony\\curso_principiante\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\form.html.twig");
    }
}
