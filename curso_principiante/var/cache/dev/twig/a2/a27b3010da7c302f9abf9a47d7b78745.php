...
class __TwigTemplate_e220a89f667bcdbe44170ff2b432d092 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    events: [ ";
            // line 167
            echo twig_call_macro($macros["__internal_parse_1"], "macro_dump_events", [(isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 167, $this->source); })())], 167, $context, $this->getSourceContext());
            echo " ],
}
";
...
{% endmacro %}
", "@WebProfiler/Collector/time.html.twig", "D:\\github\\symfony\\curso_principiante\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\time.html.twig");
    }
}
