 ...
 */
class getTareaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TareaRepository' shared autowired service.
     *
     * @return \App\Repository\TareaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TareaRepository.php';

        return $container->privates['App\\Repository\\TareaRepository'] = new \App\Repository\TareaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
